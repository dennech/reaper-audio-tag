...
function tests.test_reapack_metadata_uses_app_scoped_data_targets_and_no_setup()
  ...
  local current_version_start = assert(index_source:find('<version name="0.3.5"', 1, true))
  ...
  luaunit.assertStrContains(index_source, '<version name="0.3.5" author="dennech"')
