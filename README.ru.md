...
Локальный audio tagging для REAPER. Устанавливаешь скрипт через ReaPack, скачиваешь модель прямо из окна REAPER, затем анализируешь один выбранный audio item.
