...
- В compact-отчёте теперь используются встроенные цветные sticker-иконки вместо системных emoji, чтобы теги выглядели одинаково на разных сборках REAPER/ReaImGui.
